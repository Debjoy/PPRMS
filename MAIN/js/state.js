...
function selct_district($val)
{
 ...
 if($val=='Andhra Pradesh') {
  ...
  if ($val=='West Bengal') {
    var wb =["Alipurduar","Asansol","Baharampur","Balurghat","Bankura","Barakpore","Barasat","Bardhaman","Birbhum","Bishnupur","Chandannagar","Chinsura","Contai","Cooch Behar","Dakshin Dinajpur","Darjeeling","Durgapur","English Bazar","Hooghly","Howrah","Haldia",
                                    "Jalpaiguri","Kalimpong","Kalyani","Kharagpur","Kolkata","Krishnanagar","Maldah","Murshidabad","Nabadwip","Nadia","North 24 Parganas","Paschim Medinipur","Purba Medinipur","Purulia","Raiganj","Ranaghat","Sainthia","Serampore","South 24 Parganas","Siliguri","Tamluk","Uttar Dinajpur"];
   $(function() {
  var options = '';
